...
export const ItchIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 0L2 6.096v11.809L12 24l10-6.095V6.096L12 0zm-1.09 7.412a.895.895 0 11-1.79 0 .895.895 0 011.79 0zm4.36 0a.895.895 0 11-1.79 0 .895.895 0 011.79 0zM5.42 15.176l.01-.005.004.01zm.002-.007L12 18.588l6.578-3.419-.002.007v.005l-.004-.01-6.572 3.414-6.572-3.414z"/>
    </svg>
);
